...
function Pad({handleNumberClick, handleDelClick, handleResetClick, handleResultClick}: PadProps){  
    ...
    return (
        <div className="Pad">
            ...
            <Button estilo="BotaoNumero" text='=' onClickCallback={handleResultClick} />
        </div>
    );
}
